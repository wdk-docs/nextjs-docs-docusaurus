...
```ts title="pages/api/disable-draft.ts"
export default function handler(req, res) {
...
> **注意事项**: To test Draft Mode locally over HTTP, your browser will need to allow third-party cookies and local storage access.
