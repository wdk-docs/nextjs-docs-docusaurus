---
title: 版本 13
description: Upgrade your Next.js Application from 版本 12 to 13.
---
...
Previously, Next.js helped you optimize fonts by inlining font CSS. 版本 13 introduces the new [`next/font`](/docs/pages/building-your-application/optimizing/fonts) module which gives you the ability to customize your font loading experience while still ensuring great performance and privacy.
