...
**Note**: This is an old blog post. The features described in it are currently
documented at [§ MDX provider](/docs/using-mdx/#mdx-provider). The below is
kept as is for historical purposes.

:::note

An exciting new feature in MDX v1 is global shortcodes. This allows you to expose
components to all of your documents in your app or website. This is a useful feature
for common components like YouTube embeds, Twitter cards, or anything else frequently
