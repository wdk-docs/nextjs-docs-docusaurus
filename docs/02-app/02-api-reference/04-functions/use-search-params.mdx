...
```jsxtitle="app/dashboard/search-bar.js" switcher
'use client'
...
> **注意事项**: Setting the [`dynamic` route segment config option](/docs/app/api-reference/file-conventions/route-segment-config#dynamic) to `force-dynamic` can be used to force dynamic rendering.
