...
```jsxtitle="app/_components/web-vitals.js"
'use client'
...
```jsxtitle="app/components/web-vitals.js" switcher
'use client'
...
> **注意事项**: If you use [Google Analytics](https://analytics.google.com/analytics/web/), using the
