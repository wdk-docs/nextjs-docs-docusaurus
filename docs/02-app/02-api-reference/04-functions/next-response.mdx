...
NextResponse用额外的方便方法扩展了[Web Response API](https://developer.mozilla.org/en-US/docs/Web/API/Response)。
...
Produce a response that rewrites (proxies) the given [URL](https://developer.mozilla.org/en-US/docs/Web/API/URL) while preserving the original URL.
