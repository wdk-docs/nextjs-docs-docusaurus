...
```jsxtitle="app/about/opengraph-image.js" switcher
import { ImageResponse } from 'next/server'
...
```jsxtitle="app/shop/[slug]/opengraph-image.js" switcher
...
```jsxtitle="opengraph-image.js / twitter-image.js" switcher
export const alt = 'My images alt text'
...
```jsxtitle="app/opengraph-image.js" switcher
export const runtime = 'edge'
...
```jsxtitle="app/posts/[slug]/opengraph-image.js" switcher
import { ImageResponse } from 'next/server'
