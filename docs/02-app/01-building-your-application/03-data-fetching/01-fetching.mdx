...
为了改善用户体验，你可以添加一个[悬念边界](/docs/app/building-your-application/routing/loading-ui-and-streaming)来分解渲染工作，并尽快显示部分结果:
...
通过在[layout](/docs/app/build-your-application/routing/pages-and-layouts)中获取数据，它下面所有路由段的渲染只能在数据加载完成后才会开始。
