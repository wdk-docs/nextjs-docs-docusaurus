---
title: TypeScript
description: Next.js为构建React应用提供了typescript优先的开发体验。
---
...
Next.js为构建React应用提供了TypeScript优先的开发体验。

它带有内置的TypeScript支持，可以自动安装必要的包并配置适当的设置。
...
> **注意事项**: More features will be added in the future.
