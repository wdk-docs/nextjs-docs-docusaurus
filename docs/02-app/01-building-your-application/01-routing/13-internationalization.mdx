...
Next.js使您能够配置内容的路由和呈现，以支持多种语言。使您的站点适应不同的地区包括翻译内容(本地化)和国际化路由。

## 术语

- **Locale:** 一组语言和格式首选项的标识符。这通常包括用户的首选语言和可能的地理区域。
  - `en-US`: 美国人说的英语
  - `nl-NL`: 荷兰语:荷兰人所说的荷兰语
  - `nl`: 荷兰，没有特定地区
...
- [最小的路由和转换](https://github.com/vercel/next.js/tree/canary/examples/app-dir-i18n-routing)
