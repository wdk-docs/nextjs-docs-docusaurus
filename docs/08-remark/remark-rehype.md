...
- [remark-rehype](#remark-rehype)
  ...
  - [API](#api)
    - [`unified().use(remarkRehype[, destination][, options])`](#unifieduseremarkrehype-destination-options)
      ...
      - [`options`](#options)
        - [`options.allowDangerousHtml`](#optionsallowdangeroushtml)
        - [`options.clobberPrefix`](#optionsclobberprefix)
        - [`options.footnoteLabel`](#optionsfootnotelabel)
        - [`options.footnoteLabelTagName`](#optionsfootnotelabeltagname)
        - [`options.footnoteLabelProperties`](#optionsfootnotelabelproperties)
        - [`options.footnoteBackLabel`](#optionsfootnotebacklabel)
        - [`options.handlers`](#optionshandlers)
        - [`options.passThrough`](#optionspassthrough)
        - [`options.unknownHandler`](#optionsunknownhandler)
...
<html lang="en">
  ...
  <body>
    ...
    <p>
      Some <em>emphasis</em>, <strong>importance</strong>, and
      <code>code</code>.
    </p>
  </body>
</html>
...
_clobbering_ (`string`, default: `'user-content-'`).
