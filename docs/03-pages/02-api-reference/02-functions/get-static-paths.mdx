...
```tsx title="pages/repo/[name].tsx" switcher
import type {
...
```jsxtitle="pages/repo/[name].js" switcher
...
> **注意事项**: `fallback: true` is not supported when using [`output: 'export'`](/docs/pages/building-your-application/deploying/static-exports).
...
> **注意事项**: `fallback: 'blocking'` is not supported when using [`output: 'export'`](/docs/pages/building-your-application/deploying/static-exports).
